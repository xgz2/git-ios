...
class LoadingView: UIView {
    ...
    init() {
        ...
        loadingLabel.font = ._20NunitoBold
...
class OvalLayer: CAShapeLayer {
    ...
    let frameCenter: CGPoint = CGPoint(x: UIScreen.main.bounds.midX, y: UIScreen.main.bounds.midY)
    ...
    override init() {
        super.init()
        fillColor = UIColor(rgb: 0xFFDB59).cgColor
